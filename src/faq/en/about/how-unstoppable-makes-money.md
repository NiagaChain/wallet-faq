# How does Coinclass make money?

Coinclass is a free to use instrument that keeps all of its fundamental features free.
...
The features above are already in the implementation stage, and are designed to enable the Coinclass team to monetize itself and financially operate in DAO format moving forward.

Premium wallet features are expected to be available only to those holding special Coinclass wallet tokens.
