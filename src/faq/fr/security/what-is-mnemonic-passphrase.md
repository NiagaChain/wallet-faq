...
As enhanced security measure, some non-custodial wallets incl. Coinclass provide a way to secure a 12-24 word mnemonic phrase with an additional password phrase (aka mnemonic passphrase).
