# Does Coinclass charge fees for sending transactions?
...
These transaction fees do not pass through Coinclass but paid by the user directly to the network when executing transactions.